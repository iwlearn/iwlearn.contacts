...
def setup_product():
    ...
    import iwlearn.contacts
    zcml.load_config('configure.zcml', iwlearn.contacts)
    ...
    ztc.installPackage('iwlearn.contacts')
...
setup_product()
ptc.setupPloneSite(products=['iwlearn.contacts'])
